 ...
 */
// Instructions.
// 1.  Ensure this file and the image '515-797no09sa.jpg' are in the Moodle installation folder '/course/format/trail/test'.
...
// 3.2 In another tab of the same browser navigate to 'your moodle installation'/course/format/trail/test/test_image.php.
//     E.g. http://localhost/moodlegjb/course/format/trail/test/test_image.php.
// Success: Image shows.
...
$filepath = $CFG->dirroot . '/course/format/trail/test/' . $imagefilename;
...
$converted = $fs->convert_image($filerecord, $original, TRAIL_ITEM_IMAGE_WIDTH, TRAIL_ITEM_IMAGE_HEIGHT, true, 75);

require_once('test_header.php');
$o = html_writer::tag('h1', 'Upload and convert image....');
$o .= html_writer::start_tag('div');
$o .= html_writer::tag('p', 'Original image:');
$src = $CFG->wwwroot . '/course/format/trail/test/' . $imagefilename;
$o .= html_writer::empty_tag('img', array('src' => $src, 'alt' => 'Trail Format Image Test Original'));
$o .= html_writer::end_tag('div');
$o .= html_writer::start_tag('div');
$o .= html_writer::tag('p', 'Converted image:');
$src = moodle_url::make_pluginfile_url($contextid, 'course', 'section', $sectionid, '/trailtest/', $convertedfilename);
$o .= html_writer::empty_tag('img', array('src' => $src, 'alt' => 'Trail Format Image Test Converted'));
$o .= html_writer::end_tag('div');
...
$o .= html_writer::empty_tag('img', array('src' => $src, 'alt' => 'Trail Format Image Test Original Resized'));
$o .= html_writer::end_tag('div');
$o .= html_writer::start_tag('div');
...
$o .= html_writer::empty_tag('img', array('src' => $src, 'alt' => 'Trail Format Image Test Converted to current course settings'));
$o .= html_writer::end_tag('div');
