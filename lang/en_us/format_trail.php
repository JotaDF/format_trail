...
$string['sectiontitlesummarytextcolour_help'] = 'Set the the section title summary text color when hovering over the section title in the trail box.';
$string['defaultsectiontitlesummarytextcolour'] = 'Set the section title summary text color on hover';
$string['defaultsectiontitlesummarytextcolour_desc'] = 'Set the the section title summary text color when hovering over the section title in the trail box.';
$string['sectiontitlesummarybackgroundcolour'] = 'Set the section title summary background color on hover';
$string['sectiontitlesummarybackgroundcolour_help'] = 'Set the the section title summary background color when hovering over the section title in the trail box.';
$string['defaultsectiontitlesummarybackgroundcolour'] = 'Set the section title summary background color on hover';
$string['defaultsectiontitlesummarybackgroundcolour_desc'] = 'Set the the section title summary background color when hovering over the section title in the trail box.';
...
$string['sectiontitleinsidetitletextcolour_help'] = 'Set title text color when it is \'Inside\' the trail box.';
$string['defaultsectiontitleinsidetitletextcolour'] = 'Section title text color when \'Inside\' option';
$string['defaultsectiontitleinsidetitletextcolour_help'] = 'Set title text color when it is \'Inside\' the trail box.';
$string['sectiontitleinsidetitlebackgroundcolour'] = 'Section title background color when \'Inside\' option';
$string['sectiontitleinsidetitlebackgroundcolour_help'] = 'Set title background color when it is \'Inside\' the trail box.';
$string['defaultsectiontitleinsidetitlebackgroundcolour'] = 'Section title background color when \'Inside\' option';
$string['defaultsectiontitleinsidetitlebackgroundcolour_help'] = 'Set title background color when it is \'Inside\' the trail box.';
...
$string['resetgreyouthidden_desc'] = 'Resets the property \'Trail display show unavailable section images in gray and unlinked.\'';
$string['resetgreyouthidden_help'] = 'Resets the property \'In Trail display show unavailable section images in gray and unlinked.\'';

// Other.
$string['greyouthidden'] = 'Gray out unavailable';
$string['greyouthidden_desc'] = 'In Trail display show unavailable section images in gray and unlinked.';
$string['greyouthidden_help'] = 'In Trail display show unavailable section images in gray and unlinked.';
